# Specification: Configuration & Asset Management

## 0. Document Control

| Field | Value |
|---|---|
| Specification ID | SPMS-FUN-012 |
| Component name | Configuration & Asset Management |
...
Manages configuration items, assets, environments, topology, dependencies, baselines, versions, discovery, reconciliation, drift, environment operations, access, service mapping, impact analysis, operational handover, and auditability.

## 1.2 Scope

This component includes:

- CI, asset, environment, service, topology, interface, dependency, and ownership registries
- Configuration baselines, environment baselines, asset baselines, versioning, configuration packages, and diffs
- Discovery and synchronization from cloud, hosts, Git/IaC, CI/CD, monitoring, scanners, ITSM, and spreadsheets
- Drift detection, reconciliation, unauthorized change detection, configuration change control, impact analysis, and remediation workflows
- Environment lifecycle, readiness, access, locking, health, capacity, backup/recovery linkage, documentation, and handover packages

This component excludes:

- Deployment execution owned by Release & Deployment Management
- Security vulnerability lifecycle owned by Security & Compliance Management
- Raw cloud resource provisioning execution unless implemented through integration adapters
...
|---|---|---|---|---|
| FUN-012-CAP-01 | Configuration item registry | Configuration item registry capability for Configuration & Asset Management. | Must | Yes |
| FUN-012-CAP-02 | Asset inventory management | Asset inventory management capability for Configuration & Asset Management. | Must | Yes |
| FUN-012-CAP-03 | Environment registry and lifecycle | Environment registry and lifecycle capability for Configuration & Asset Management. | Must | Yes |
| FUN-012-CAP-04 | Relationship and topology model | Relationship and topology model capability for Configuration & Asset Management. | Must | Yes |
| FUN-012-CAP-05 | Baseline and configuration control | Baseline and configuration control capability for Configuration & Asset Management. | Must | Yes |
| FUN-012-CAP-06 | Configuration versioning | Configuration versioning capability for Configuration & Asset Management. | Must | No |
| FUN-012-CAP-07 | Discovery and synchronization | Discovery and synchronization capability for Configuration & Asset Management. | Must | No |
| FUN-012-CAP-08 | Drift detection and reconciliation | Drift detection and reconciliation capability for Configuration & Asset Management. | Must | No |
| FUN-012-CAP-09 | Configuration change control | Configuration change control capability for Configuration & Asset Management. | Must | No |
| FUN-012-CAP-10 | Asset dependency and impact analysis | Asset dependency and impact analysis capability for Configuration & Asset Management. | Must | No |

## 4.2 Capability Details

## Capability: `Configuration item registry`

| Field | Description |
|---|---|
| Capability ID | FUN-012-CAP-01 |
| Purpose | Provide controlled configuration item registry within Configuration & Asset Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
...
| Field | Description |
|---|---|
| Capability ID | FUN-012-CAP-02 |
| Purpose | Provide controlled asset inventory management within Configuration & Asset Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Environment registry and lifecycle`

| Field | Description |
|---|---|
| Capability ID | FUN-012-CAP-03 |
| Purpose | Provide controlled environment registry and lifecycle within Configuration & Asset Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Relationship and topology model`

| Field | Description |
|---|---|
| Capability ID | FUN-012-CAP-04 |
| Purpose | Provide controlled relationship and topology model within Configuration & Asset Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Baseline and configuration control`

| Field | Description |
|---|---|
| Capability ID | FUN-012-CAP-05 |
| Purpose | Provide controlled baseline and configuration control within Configuration & Asset Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | FUN-012-CAP-06 |
| Purpose | Provide controlled configuration versioning within Configuration & Asset Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Discovery and synchronization`

| Field | Description |
|---|---|
| Capability ID | FUN-012-CAP-07 |
| Purpose | Provide controlled discovery and synchronization within Configuration & Asset Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Drift detection and reconciliation`

| Field | Description |
|---|---|
| Capability ID | FUN-012-CAP-08 |
| Purpose | Provide controlled drift detection and reconciliation within Configuration & Asset Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | FUN-012-CAP-09 |
| Purpose | Provide controlled configuration change control within Configuration & Asset Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Asset dependency and impact analysis`

| Field | Description |
|---|---|
| Capability ID | FUN-012-CAP-10 |
| Purpose | Provide controlled asset dependency and impact analysis within Configuration & Asset Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
|---|---|---|
| ConfigurationItem | Managed entity for Configuration & Asset Management. | Yes |
| Asset | Managed entity for Configuration & Asset Management. | Yes |
| Environment | Managed entity for Configuration & Asset Management. | Yes |
| Service | Managed entity for Configuration & Asset Management. | Yes |
| Interface | Managed entity for Configuration & Asset Management. | Yes |
| Dependency | Managed entity for Configuration & Asset Management. | Yes |
| ConfigurationBaseline | Managed entity for Configuration & Asset Management. | Yes |
| DiscoverySource | Managed entity for Configuration & Asset Management. | Yes |
| DriftRecord | Managed entity for Configuration & Asset Management. | Yes |
| InstallationRecord | Managed entity for Configuration & Asset Management. | Yes |
...
|---|---|---|---|
| Primary records | Configuration & Asset Management | Search, reporting, graph, workflow, evidence, integrations | Component APIs, imports, automation, authorized users |
...
- CI relationships should include depends-on, hosted-on, connected-to, deployed-to, runs-on, stores-data-in, backed-up-by, secured-by, monitored-by, owned-by, supports, consumes, exposes, implements.
- Discovered state must be reconciled against declared state with confidence scoring.
- Environment readiness must check health, capacity, versions, configuration, secrets references, dependencies, data state, and monitoring.
