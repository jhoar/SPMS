# Specification: Security & Compliance Management

## 0. Document Control

| Field | Value |
|---|---|
| Specification ID | SPMS-FUN-013 |
| Component name | Security & Compliance Management |
...
Manages security governance, controls, vulnerabilities, threats, risks, privacy, compliance mappings, exceptions, remediation, evidence, audits, security gates, access compliance, supply-chain assurance, and continuous control validation.

## 1.2 Scope

This component includes:

- Security programmes, policy, standards, control library, compliance frameworks, applicability, and control evidence
- Protected asset scope, security requirements, threat modelling, architecture review, security risks, and privacy/data protection records
- Vulnerability intake, scanner ingestion, normalization, prioritization, triage, remediation, verification, exceptions, and SLAs
- Supply-chain controls including SBOMs, dependencies, licenses, provenance, signing, attestations, trusted registry policies, and supplier software risk
- Compliance assessments, audit management, evidence requests, security release gates, monitoring integration, incident linkage, reporting, and AI assistance

This component excludes:

- Primary asset inventory ownership owned by Configuration & Asset Management
- Build execution and artifact publishing owned by Build & CI/CD Management
- General issue remediation work tracking owned by Issue & Change Management
...
|---|---|---|---|---|
| FUN-013-CAP-01 | Security governance model | Security governance model capability for Security & Compliance Management. | Must | Yes |
| FUN-013-CAP-02 | Control framework and compliance mapping | Control framework and compliance mapping capability for Security & Compliance Management. | Must | Yes |
| FUN-013-CAP-03 | Security risk management | Security risk management capability for Security & Compliance Management. | Must | Yes |
| FUN-013-CAP-04 | Threat modelling | Threat modelling capability for Security & Compliance Management. | Must | Yes |
| FUN-013-CAP-05 | Vulnerability intake and discovery | Vulnerability intake and discovery capability for Security & Compliance Management. | Must | Yes |
| FUN-013-CAP-06 | Vulnerability prioritization | Vulnerability prioritization capability for Security & Compliance Management. | Must | No |
| FUN-013-CAP-07 | Triage and lifecycle management | Triage and lifecycle management capability for Security & Compliance Management. | Must | No |
| FUN-013-CAP-08 | Patch and remediation management | Patch and remediation management capability for Security & Compliance Management. | Must | No |
| FUN-013-CAP-09 | Policy and control exception management | Policy and control exception management capability for Security & Compliance Management. | Must | No |
| FUN-013-CAP-10 | Privacy and data protection management | Privacy and data protection management capability for Security & Compliance Management. | Must | No |

## 4.2 Capability Details

## Capability: `Security governance model`

| Field | Description |
|---|---|
| Capability ID | FUN-013-CAP-01 |
| Purpose | Provide controlled security governance model within Security & Compliance Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
...
## Capability: `Control framework and compliance mapping`

| Field | Description |
|---|---|
| Capability ID | FUN-013-CAP-02 |
| Purpose | Provide controlled control framework and compliance mapping within Security & Compliance Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Security risk management`

| Field | Description |
|---|---|
| Capability ID | FUN-013-CAP-03 |
| Purpose | Provide controlled security risk management within Security & Compliance Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | FUN-013-CAP-04 |
| Purpose | Provide controlled threat modelling within Security & Compliance Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Vulnerability intake and discovery`

| Field | Description |
|---|---|
| Capability ID | FUN-013-CAP-05 |
| Purpose | Provide controlled vulnerability intake and discovery within Security & Compliance Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | FUN-013-CAP-06 |
| Purpose | Provide controlled vulnerability prioritization within Security & Compliance Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Triage and lifecycle management`

| Field | Description |
|---|---|
| Capability ID | FUN-013-CAP-07 |
| Purpose | Provide controlled triage and lifecycle management within Security & Compliance Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Patch and remediation management`

| Field | Description |
|---|---|
| Capability ID | FUN-013-CAP-08 |
| Purpose | Provide controlled patch and remediation management within Security & Compliance Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | FUN-013-CAP-09 |
| Purpose | Provide controlled policy and control exception management within Security & Compliance Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Privacy and data protection management`

| Field | Description |
|---|---|
| Capability ID | FUN-013-CAP-10 |
| Purpose | Provide controlled privacy and data protection management within Security & Compliance Management, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
|---|---|---|
| SecurityControl | Managed entity for Security & Compliance Management. | Yes |
| ComplianceFramework | Managed entity for Security & Compliance Management. | Yes |
| SecurityRequirement | Managed entity for Security & Compliance Management. | Yes |
| ThreatModel | Managed entity for Security & Compliance Management. | Yes |
| Threat | Managed entity for Security & Compliance Management. | Yes |
| SecurityRisk | Managed entity for Security & Compliance Management. | Yes |
| Vulnerability | Managed entity for Security & Compliance Management. | Yes |
| Finding | Managed entity for Security & Compliance Management. | Yes |
| Exception | Managed entity for Security & Compliance Management. | Yes |
| PrivacyAssessment | Managed entity for Security & Compliance Management. | Yes |
...
|---|---|---|---|
| Primary records | Security & Compliance Management | Search, reporting, graph, workflow, evidence, integrations | Component APIs, imports, automation, authorized users |
...
- Vulnerability prioritization should combine severity, exploitability, asset criticality, exposure, reachability, business impact, and control context.
- Exceptions must have rationale, impact analysis, risk acceptance, compensating controls, expiry, renewal, and closure rules.
- Security release gates must summarize blockers, accepted risks, exceptions, and evidence for go/no-go decisions.
