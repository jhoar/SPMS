# Specification: Reporting & Analytics

## 0. Document Control

| Field | Value |
|---|---|
| Specification ID | SPMS-FUN-015 |
| Component name | Reporting & Analytics |
| Component type | UI capability |
| Version | 0.1 |
| Status | Draft |
| Owner | TBD |
...
Provides operational, management, portfolio, executive, audit, compliance, quality, security, release, deployment, test, pipeline, configuration, and product assurance reporting across the platform, with drill-down to source records and evidence.

## 1.2 Scope

This component includes:

- Dashboards for project status, portfolio health, workload, flow, risk, readiness, coverage, defects, quality, security posture, compliance, releases, deployments, drift, and evidence completeness
- Metric definitions, metric lineage, trends, time-series aggregation, snapshots, thresholds, targets, RAG health, and executive views
- Scheduled reporting, exports, BI integration, data marts, report templates, subscriptions, and access-controlled sharing
- Drill-down from indicators to source records, graph links, audit records, and evidence packages
- Analytics governance including metric ownership, calculation definitions, freshness, permissions, and confidence indicators

This component excludes:

- Raw search capability owned by Search, Query, Views, Dashboards, Reporting substrate
- Authoritative source data owned by functional modules
- Predictive AI recommendations owned by Automation & AI Assistance unless embedded as analytics widgets
...
|---|---|---|---|---|
| FUN-015-CAP-01 | Executive dashboards | Executive dashboards capability for Reporting & Analytics. | Must | Yes |
| FUN-015-CAP-02 | Operational dashboards | Operational dashboards capability for Reporting & Analytics. | Must | Yes |
| FUN-015-CAP-03 | Metric definition registry | Metric definition registry capability for Reporting & Analytics. | Must | Yes |
| FUN-015-CAP-04 | Trend analytics | Trend analytics capability for Reporting & Analytics. | Must | Yes |
| FUN-015-CAP-05 | Readiness and coverage reporting | Readiness and coverage reporting capability for Reporting & Analytics. | Must | Yes |
| FUN-015-CAP-06 | Risk and compliance reporting | Risk and compliance reporting capability for Reporting & Analytics. | Must | No |
| FUN-015-CAP-07 | Quality and defect analytics | Quality and defect analytics capability for Reporting & Analytics. | Must | No |
| FUN-015-CAP-08 | Portfolio reporting | Portfolio reporting capability for Reporting & Analytics. | Must | No |
| FUN-015-CAP-09 | BI exports | BI exports capability for Reporting & Analytics. | Must | No |
| FUN-015-CAP-10 | Scheduled reports and subscriptions | Scheduled reports and subscriptions capability for Reporting & Analytics. | Must | No |

## 4.2 Capability Details

## Capability: `Executive dashboards`

| Field | Description |
|---|---|
| Capability ID | FUN-015-CAP-01 |
| Purpose | Provide controlled executive dashboards within Reporting & Analytics, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
...
| Field | Description |
|---|---|
| Capability ID | FUN-015-CAP-02 |
| Purpose | Provide controlled operational dashboards within Reporting & Analytics, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Metric definition registry`

| Field | Description |
|---|---|
| Capability ID | FUN-015-CAP-03 |
| Purpose | Provide controlled metric definition registry within Reporting & Analytics, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Trend analytics`

| Field | Description |
|---|---|
| Capability ID | FUN-015-CAP-04 |
| Purpose | Provide controlled trend analytics within Reporting & Analytics, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Readiness and coverage reporting`

| Field | Description |
|---|---|
| Capability ID | FUN-015-CAP-05 |
| Purpose | Provide controlled readiness and coverage reporting within Reporting & Analytics, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Risk and compliance reporting`

| Field | Description |
|---|---|
| Capability ID | FUN-015-CAP-06 |
| Purpose | Provide controlled risk and compliance reporting within Reporting & Analytics, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Quality and defect analytics`

| Field | Description |
|---|---|
| Capability ID | FUN-015-CAP-07 |
| Purpose | Provide controlled quality and defect analytics within Reporting & Analytics, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Portfolio reporting`

| Field | Description |
|---|---|
| Capability ID | FUN-015-CAP-08 |
| Purpose | Provide controlled portfolio reporting within Reporting & Analytics, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `BI exports`

| Field | Description |
|---|---|
| Capability ID | FUN-015-CAP-09 |
| Purpose | Provide controlled bi exports within Reporting & Analytics, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Scheduled reports and subscriptions`

| Field | Description |
|---|---|
| Capability ID | FUN-015-CAP-10 |
| Purpose | Provide controlled scheduled reports and subscriptions within Reporting & Analytics, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
|---|---|---|
| Dashboard | Managed entity for Reporting & Analytics. | Yes |
| Widget | Managed entity for Reporting & Analytics. | Yes |
| Metric | Managed entity for Reporting & Analytics. | Yes |
| MetricDefinition | Managed entity for Reporting & Analytics. | Yes |
| AnalyticsSnapshot | Managed entity for Reporting & Analytics. | Yes |
| Report | Managed entity for Reporting & Analytics. | Yes |
| ReportTemplate | Managed entity for Reporting & Analytics. | Yes |
| BIExport | Managed entity for Reporting & Analytics. | Yes |
| Subscription | Managed entity for Reporting & Analytics. | Yes |
| ExecutiveView | Managed entity for Reporting & Analytics. | Yes |
...
|---|---|---|---|
| Primary records | Reporting & Analytics | Search, reporting, graph, workflow, evidence, integrations | Component APIs, imports, automation, authorized users |
...
- Every metric must have an owner, definition, data source, refresh frequency, calculation logic, and permission model.
- Executive summaries must preserve drill-down to evidence and raw records.
- Analytics snapshots should support audit-period reconstruction.
