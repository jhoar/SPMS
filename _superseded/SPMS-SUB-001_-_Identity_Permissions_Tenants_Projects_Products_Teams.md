# Specification: Identity, Permissions, Tenants, Projects, Products, Teams

## 0. Document Control

| Field | Value |
|---|---|
| Specification ID | SPMS-SUB-001 |
| Component name | Identity, Permissions, Tenants, Projects, Products, Teams |
...
Provides the organizational, identity, access-control, and ownership foundation for the whole platform. It defines tenants, users, groups, roles, permissions, projects, products, teams, service accounts, delegation, and separation-of-duty rules so every record, workflow, approval, evidence item, and integration actor has a controlled security and accountability context.
...
- User, group, service-account, tenant, project, product, and team administration
- RBAC, ABAC, object-level, field-level, environment-level, and approval-authority permissions
- Delegation, external collaborator access, privileged access governance, and separation-of-duty enforcement
- Ownership, accountability, RACI, notification scope, and access review evidence

This component excludes:

- Business-specific lifecycle logic owned by functional modules
- Raw secret storage, which must remain in an external secret manager
- Detailed security control and vulnerability lifecycle, owned by Security & Compliance Management
...
| Product Assurance | Primary owner or direct specialization for this component. |
...
|---|---|---|---|---|
| SUB-001-CAP-01 | Tenant and organization management | Tenant and organization management capability for Identity, Permissions, Tenants, Projects, Products, Teams. | Must | Yes |
| SUB-001-CAP-02 | User and group management | User and group management capability for Identity, Permissions, Tenants, Projects, Products, Teams. | Must | Yes |
| SUB-001-CAP-03 | Project/product/team registry | Project/product/team registry capability for Identity, Permissions, Tenants, Projects, Products, Teams. | Must | Yes |
| SUB-001-CAP-04 | Authentication and SSO integration | Authentication and SSO integration capability for Identity, Permissions, Tenants, Projects, Products, Teams. | Must | Yes |
| SUB-001-CAP-05 | RBAC and ABAC authorization | RBAC and ABAC authorization capability for Identity, Permissions, Tenants, Projects, Products, Teams. | Must | Yes |
| SUB-001-CAP-06 | Object and field-level permissions | Object and field-level permissions capability for Identity, Permissions, Tenants, Projects, Products, Teams. | Must | No |
| SUB-001-CAP-07 | Approval authority and delegation | Approval authority and delegation capability for Identity, Permissions, Tenants, Projects, Products, Teams. | Must | No |
| SUB-001-CAP-08 | External collaborator access | External collaborator access capability for Identity, Permissions, Tenants, Projects, Products, Teams. | Must | No |
| SUB-001-CAP-09 | Separation of duties | Separation of duties capability for Identity, Permissions, Tenants, Projects, Products, Teams. | Must | No |
| SUB-001-CAP-10 | Access review and evidence | Access review and evidence capability for Identity, Permissions, Tenants, Projects, Products, Teams. | Must | No |

## 4.2 Capability Details

## Capability: `Tenant and organization management`

| Field | Description |
|---|---|
| Capability ID | SUB-001-CAP-01 |
| Purpose | Provide controlled tenant and organization management within Identity, Permissions, Tenants, Projects, Products, Teams, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-001-CAP-02 |
| Purpose | Provide controlled user and group management within Identity, Permissions, Tenants, Projects, Products, Teams, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-001-CAP-03 |
| Purpose | Provide controlled project/product/team registry within Identity, Permissions, Tenants, Projects, Products, Teams, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Authentication and SSO integration`

| Field | Description |
|---|---|
| Capability ID | SUB-001-CAP-04 |
| Purpose | Provide controlled authentication and sso integration within Identity, Permissions, Tenants, Projects, Products, Teams, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-001-CAP-05 |
| Purpose | Provide controlled rbac and abac authorization within Identity, Permissions, Tenants, Projects, Products, Teams, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-001-CAP-06 |
| Purpose | Provide controlled object and field-level permissions within Identity, Permissions, Tenants, Projects, Products, Teams, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-001-CAP-07 |
| Purpose | Provide controlled approval authority and delegation within Identity, Permissions, Tenants, Projects, Products, Teams, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `External collaborator access`

| Field | Description |
|---|---|
| Capability ID | SUB-001-CAP-08 |
| Purpose | Provide controlled external collaborator access within Identity, Permissions, Tenants, Projects, Products, Teams, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-001-CAP-09 |
| Purpose | Provide controlled separation of duties within Identity, Permissions, Tenants, Projects, Products, Teams, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-001-CAP-10 |
| Purpose | Provide controlled access review and evidence within Identity, Permissions, Tenants, Projects, Products, Teams, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
|---|---|---|
| Tenant | Managed entity for Identity, Permissions, Tenants, Projects, Products, Teams. | Yes |
| User | Managed entity for Identity, Permissions, Tenants, Projects, Products, Teams. | Yes |
| Group | Managed entity for Identity, Permissions, Tenants, Projects, Products, Teams. | Yes |
| Team | Managed entity for Identity, Permissions, Tenants, Projects, Products, Teams. | Yes |
| Role | Managed entity for Identity, Permissions, Tenants, Projects, Products, Teams. | Yes |
| Permission | Managed entity for Identity, Permissions, Tenants, Projects, Products, Teams. | Yes |
| Project | Managed entity for Identity, Permissions, Tenants, Projects, Products, Teams. | Yes |
| Product | Managed entity for Identity, Permissions, Tenants, Projects, Products, Teams. | Yes |
| ServiceAccount | Managed entity for Identity, Permissions, Tenants, Projects, Products, Teams. | Yes |
| Delegation | Managed entity for Identity, Permissions, Tenants, Projects, Products, Teams. | Yes |
| AccessReview | Managed entity for Identity, Permissions, Tenants, Projects, Products, Teams. | Yes |
...
|---|---|---|---|
| Primary records | Identity, Permissions, Tenants, Projects, Products, Teams | Search, reporting, graph, workflow, evidence, integrations | Component APIs, imports, automation, authorized users |
...
- Permission inheritance order: tenant → project/product → team → object → field/action override.
- Service accounts must have owners, purpose, scope, expiry, and audit trail.
- Delegated authority must be time-limited and visible in approval records.
