# Specification: Common Record Model, Metadata, Classification, Lifecycle

## 0. Document Control

| Field | Value |
|---|---|
| Specification ID | SPMS-SUB-002 |
| Component name | Common Record Model, Metadata, Classification, Lifecycle |
...
Defines the canonical record pattern used by all modules: identity, title, owner, status, version, classification, lifecycle state, timestamps, comments, attachments, relationships, approvals, evidence references, and audit history. It ensures requirements, issues, documents, tests, releases, assets, risks, waivers, and analytics records behave consistently across the system.

## 1.2 Scope

This component includes:

- Common object identity, metadata, ownership, status, classification, and lifecycle conventions
- Record typing, custom fields, validation rules, taxonomies, tags, labels, and controlled vocabularies
- Common comment, attachment, activity, state, version, and soft-delete conventions
- Applicability by tenant, project, product, release, environment, customer, platform, region, variant, and governance profile
- Metadata quality, required-field checks, classification enforcement, and lifecycle transition hooks

This component excludes:

- Specialized domain attributes owned by functional modules
- Workflow execution logic owned by Workflow, Approval, Gate, Waiver, and Delegation Engine
- Storage engine implementation details owned by the infrastructure substrate
...
|---|---|---|---|---|
| SUB-002-CAP-01 | Canonical record identity | Canonical record identity capability for Common Record Model, Metadata, Classification, Lifecycle. | Must | Yes |
| SUB-002-CAP-02 | Metadata schema management | Metadata schema management capability for Common Record Model, Metadata, Classification, Lifecycle. | Must | Yes |
| SUB-002-CAP-03 | Classification and sensitivity labeling | Classification and sensitivity labeling capability for Common Record Model, Metadata, Classification, Lifecycle. | Must | Yes |
| SUB-002-CAP-04 | Lifecycle state model | Lifecycle state model capability for Common Record Model, Metadata, Classification, Lifecycle. | Must | Yes |
| SUB-002-CAP-05 | Custom fields and validation | Custom fields and validation capability for Common Record Model, Metadata, Classification, Lifecycle. | Must | Yes |
| SUB-002-CAP-06 | Taxonomy and controlled vocabulary | Taxonomy and controlled vocabulary capability for Common Record Model, Metadata, Classification, Lifecycle. | Must | No |
| SUB-002-CAP-07 | Applicability and variants | Applicability and variants capability for Common Record Model, Metadata, Classification, Lifecycle. | Must | No |
| SUB-002-CAP-08 | Comment and activity model | Comment and activity model capability for Common Record Model, Metadata, Classification, Lifecycle. | Must | No |
| SUB-002-CAP-09 | Attachment reference model | Attachment reference model capability for Common Record Model, Metadata, Classification, Lifecycle. | Must | No |
| SUB-002-CAP-10 | Record quality checks | Record quality checks capability for Common Record Model, Metadata, Classification, Lifecycle. | Must | No |

## 4.2 Capability Details

## Capability: `Canonical record identity`

| Field | Description |
|---|---|
| Capability ID | SUB-002-CAP-01 |
| Purpose | Provide controlled canonical record identity within Common Record Model, Metadata, Classification, Lifecycle, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
...
## Capability: `Metadata schema management`

| Field | Description |
|---|---|
| Capability ID | SUB-002-CAP-02 |
| Purpose | Provide controlled metadata schema management within Common Record Model, Metadata, Classification, Lifecycle, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Classification and sensitivity labeling`

| Field | Description |
|---|---|
| Capability ID | SUB-002-CAP-03 |
| Purpose | Provide controlled classification and sensitivity labeling within Common Record Model, Metadata, Classification, Lifecycle, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-002-CAP-04 |
| Purpose | Provide controlled lifecycle state model within Common Record Model, Metadata, Classification, Lifecycle, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-002-CAP-05 |
| Purpose | Provide controlled custom fields and validation within Common Record Model, Metadata, Classification, Lifecycle, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Taxonomy and controlled vocabulary`

| Field | Description |
|---|---|
| Capability ID | SUB-002-CAP-06 |
| Purpose | Provide controlled taxonomy and controlled vocabulary within Common Record Model, Metadata, Classification, Lifecycle, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Applicability and variants`

| Field | Description |
|---|---|
| Capability ID | SUB-002-CAP-07 |
| Purpose | Provide controlled applicability and variants within Common Record Model, Metadata, Classification, Lifecycle, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Comment and activity model`

| Field | Description |
|---|---|
| Capability ID | SUB-002-CAP-08 |
| Purpose | Provide controlled comment and activity model within Common Record Model, Metadata, Classification, Lifecycle, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Attachment reference model`

| Field | Description |
|---|---|
| Capability ID | SUB-002-CAP-09 |
| Purpose | Provide controlled attachment reference model within Common Record Model, Metadata, Classification, Lifecycle, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-002-CAP-10 |
| Purpose | Provide controlled record quality checks within Common Record Model, Metadata, Classification, Lifecycle, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
|---|---|---|
| Record | Managed entity for Common Record Model, Metadata, Classification, Lifecycle. | Yes |
| RecordType | Managed entity for Common Record Model, Metadata, Classification, Lifecycle. | Yes |
| MetadataSchema | Managed entity for Common Record Model, Metadata, Classification, Lifecycle. | Yes |
| FieldDefinition | Managed entity for Common Record Model, Metadata, Classification, Lifecycle. | Yes |
| ClassificationLabel | Managed entity for Common Record Model, Metadata, Classification, Lifecycle. | Yes |
| LifecycleState | Managed entity for Common Record Model, Metadata, Classification, Lifecycle. | Yes |
| TaxonomyTerm | Managed entity for Common Record Model, Metadata, Classification, Lifecycle. | Yes |
| Comment | Managed entity for Common Record Model, Metadata, Classification, Lifecycle. | Yes |
| AttachmentReference | Managed entity for Common Record Model, Metadata, Classification, Lifecycle. | Yes |
| ActivityItem | Managed entity for Common Record Model, Metadata, Classification, Lifecycle. | Yes |
...
|---|---|---|---|
| Primary records | Common Record Model, Metadata, Classification, Lifecycle | Search, reporting, graph, workflow, evidence, integrations | Component APIs, imports, automation, authorized users |
...
- All controlled records must have immutable IDs independent of title, location, or hierarchy.
- Classification labels must influence permissions, export rules, retention, AI retrieval, and external sharing.
- The common lifecycle model must allow module-specific states without breaking cross-module reporting.
