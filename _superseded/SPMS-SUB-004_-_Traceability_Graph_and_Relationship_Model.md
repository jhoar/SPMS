# Specification: Traceability Graph and Relationship Model

## 0. Document Control

| Field | Value |
|---|---|
| Specification ID | SPMS-SUB-004 |
| Component name | Traceability Graph and Relationship Model |
...
Provides the shared relationship model, graph projection, bidirectional navigation, trace coverage, impact analysis, suspect-link logic, topology modelling, dependency analysis, and historical trace reconstruction used by all modules.

## 1.2 Scope

This component includes:

- Canonical relationship types, cardinality, direction, validity, and required coverage rules
- Graph projection across requirements, issues, work packages, documents, tests, builds, releases, deployments, assets, controls, risks, waivers, and evidence
- Traceability matrices, impact graphs, dependency graphs, topology views, and coverage dashboards
- Suspect-link detection when related records change after approval, baseline, verification, or release
- Historical graph reconstruction for baseline, release, deployment, audit, and acceptance points

This component excludes:

- Authoritative storage of domain records owned by modules
- Full-text search ranking owned by Search, Query, Views, Dashboards, Reporting
- Low-level graph database infrastructure owned by the infrastructure substrate
...
| Traceability Graph Core | Primary owner or direct specialization for this component. |
...
|---|---|---|---|---|
| SUB-004-CAP-01 | Relationship type registry | Relationship type registry capability for Traceability Graph and Relationship Model. | Must | Yes |
| SUB-004-CAP-02 | Bidirectional trace links | Bidirectional trace links capability for Traceability Graph and Relationship Model. | Must | Yes |
| SUB-004-CAP-03 | Coverage rules | Coverage rules capability for Traceability Graph and Relationship Model. | Must | Yes |
| SUB-004-CAP-04 | Traceability matrices | Traceability matrices capability for Traceability Graph and Relationship Model. | Must | Yes |
| SUB-004-CAP-05 | Impact analysis | Impact analysis capability for Traceability Graph and Relationship Model. | Must | Yes |
| SUB-004-CAP-06 | Suspect link detection | Suspect link detection capability for Traceability Graph and Relationship Model. | Must | No |
| SUB-004-CAP-07 | Dependency and topology graph | Dependency and topology graph capability for Traceability Graph and Relationship Model. | Must | No |
| SUB-004-CAP-08 | Graph query API | Graph query API capability for Traceability Graph and Relationship Model. | Must | No |
| SUB-004-CAP-09 | Historical graph snapshots | Historical graph snapshots capability for Traceability Graph and Relationship Model. | Must | No |
| SUB-004-CAP-10 | Traceability health metrics | Traceability health metrics capability for Traceability Graph and Relationship Model. | Must | No |

## 4.2 Capability Details

## Capability: `Relationship type registry`

| Field | Description |
|---|---|
| Capability ID | SUB-004-CAP-01 |
| Purpose | Provide controlled relationship type registry within Traceability Graph and Relationship Model, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
...
## Capability: `Bidirectional trace links`

| Field | Description |
|---|---|
| Capability ID | SUB-004-CAP-02 |
| Purpose | Provide controlled bidirectional trace links within Traceability Graph and Relationship Model, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-004-CAP-03 |
| Purpose | Provide controlled coverage rules within Traceability Graph and Relationship Model, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-004-CAP-04 |
| Purpose | Provide controlled traceability matrices within Traceability Graph and Relationship Model, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-004-CAP-05 |
| Purpose | Provide controlled impact analysis within Traceability Graph and Relationship Model, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Suspect link detection`

| Field | Description |
|---|---|
| Capability ID | SUB-004-CAP-06 |
| Purpose | Provide controlled suspect link detection within Traceability Graph and Relationship Model, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Dependency and topology graph`

| Field | Description |
|---|---|
| Capability ID | SUB-004-CAP-07 |
| Purpose | Provide controlled dependency and topology graph within Traceability Graph and Relationship Model, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-004-CAP-08 |
| Purpose | Provide controlled graph query api within Traceability Graph and Relationship Model, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-004-CAP-09 |
| Purpose | Provide controlled historical graph snapshots within Traceability Graph and Relationship Model, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-004-CAP-10 |
| Purpose | Provide controlled traceability health metrics within Traceability Graph and Relationship Model, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
|---|---|---|
| TraceLink | Managed entity for Traceability Graph and Relationship Model. | Yes |
| RelationshipType | Managed entity for Traceability Graph and Relationship Model. | Yes |
| GraphNodeProjection | Managed entity for Traceability Graph and Relationship Model. | Yes |
| GraphEdgeProjection | Managed entity for Traceability Graph and Relationship Model. | Yes |
| TraceMatrix | Managed entity for Traceability Graph and Relationship Model. | Yes |
| CoverageRule | Managed entity for Traceability Graph and Relationship Model. | Yes |
| ImpactAnalysisRun | Managed entity for Traceability Graph and Relationship Model. | Yes |
| SuspectLink | Managed entity for Traceability Graph and Relationship Model. | Yes |
| TopologyView | Managed entity for Traceability Graph and Relationship Model. | Yes |
| GraphSnapshot | Managed entity for Traceability Graph and Relationship Model. | Yes |
...
|---|---|---|---|
| Primary records | Traceability Graph and Relationship Model | Search, reporting, graph, workflow, evidence, integrations | Component APIs, imports, automation, authorized users |
...
- The graph must support both current-state traversal and historical baseline traversal.
- Every link must have source, target, type, creator, timestamp, rationale, confidence, and validity state.
- Suspect-link algorithms must be deterministic and explainable for audit use.
