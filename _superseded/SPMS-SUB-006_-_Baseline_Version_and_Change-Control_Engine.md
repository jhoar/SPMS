# Specification: Baseline, Version, and Change-Control Engine

## 0. Document Control

| Field | Value |
|---|---|
| Specification ID | SPMS-SUB-006 |
| Component name | Baseline, Version, and Change-Control Engine |
...
|---|---|---|---|---|
| SUB-006-CAP-01 | Baseline creation | Baseline creation capability for Baseline, Version, and Change-Control Engine. | Must | Yes |
| SUB-006-CAP-02 | Baseline approval | Baseline approval capability for Baseline, Version, and Change-Control Engine. | Must | Yes |
| SUB-006-CAP-03 | Baseline comparison | Baseline comparison capability for Baseline, Version, and Change-Control Engine. | Must | Yes |
| SUB-006-CAP-04 | Version registry | Version registry capability for Baseline, Version, and Change-Control Engine. | Must | Yes |
| SUB-006-CAP-05 | Version lineage | Version lineage capability for Baseline, Version, and Change-Control Engine. | Must | Yes |
| SUB-006-CAP-06 | Change request lifecycle | Change request lifecycle capability for Baseline, Version, and Change-Control Engine. | Must | No |
| SUB-006-CAP-07 | Impact analysis | Impact analysis capability for Baseline, Version, and Change-Control Engine. | Must | No |
| SUB-006-CAP-08 | Controlled update locking | Controlled update locking capability for Baseline, Version, and Change-Control Engine. | Must | No |
| SUB-006-CAP-09 | Rollback and supersede | Rollback and supersede capability for Baseline, Version, and Change-Control Engine. | Must | No |
| SUB-006-CAP-10 | Baseline audit export | Baseline audit export capability for Baseline, Version, and Change-Control Engine. | Must | No |
