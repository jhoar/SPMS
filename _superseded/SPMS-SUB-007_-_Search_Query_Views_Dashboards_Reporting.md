# Specification: Search, Query, Views, Dashboards, Reporting

## 0. Document Control

| Field | Value |
|---|---|
| Specification ID | SPMS-SUB-007 |
| Component name | Search, Query, Views, Dashboards, Reporting |
...
Provides the shared retrieval, operational view, dashboard, reporting, metric, export, graph navigation, semantic search, and natural-language query capability across all modules.

## 1.2 Scope

This component includes:

- Full-text, faceted, structured, graph, semantic, and natural-language search over approved records and evidence
- Personal, team, project, product, portfolio, audit, release, compliance, environment, and executive views
- Dashboards for status, readiness, risk, coverage, quality, security, workload, drift, deployments, and evidence completeness
- Report generation, scheduled reports, BI exports, drill-down, and source-to-indicator traceability
- Saved queries, filter sharing, permissions-aware indexing, and export control

This component excludes:

- Authoritative record creation owned by functional modules
- Raw analytics warehouse implementation owned by infrastructure substrate
- AI drafting and automation execution owned by Automation & AI Assistance
...
| Reporting & Analytics | Primary owner or direct specialization for this component. |
...
|---|---|---|---|---|
| SUB-007-CAP-01 | Full-text search | Full-text search capability for Search, Query, Views, Dashboards, Reporting. | Must | Yes |
| SUB-007-CAP-02 | Structured filtering | Structured filtering capability for Search, Query, Views, Dashboards, Reporting. | Must | Yes |
| SUB-007-CAP-03 | Advanced query language | Advanced query language capability for Search, Query, Views, Dashboards, Reporting. | Must | Yes |
| SUB-007-CAP-04 | Graph navigation | Graph navigation capability for Search, Query, Views, Dashboards, Reporting. | Must | Yes |
| SUB-007-CAP-05 | Semantic search | Semantic search capability for Search, Query, Views, Dashboards, Reporting. | Must | Yes |
| SUB-007-CAP-06 | Natural-language Q&A | Natural-language Q&A capability for Search, Query, Views, Dashboards, Reporting. | Must | No |
| SUB-007-CAP-07 | Saved views | Saved views capability for Search, Query, Views, Dashboards, Reporting. | Must | No |
| SUB-007-CAP-08 | Dashboards and widgets | Dashboards and widgets capability for Search, Query, Views, Dashboards, Reporting. | Must | No |
| SUB-007-CAP-09 | Scheduled reporting | Scheduled reporting capability for Search, Query, Views, Dashboards, Reporting. | Must | No |
| SUB-007-CAP-10 | BI/export integration | BI/export integration capability for Search, Query, Views, Dashboards, Reporting. | Must | No |
...
| Field | Description |
|---|---|
| Capability ID | SUB-007-CAP-01 |
| Purpose | Provide controlled full-text search within Search, Query, Views, Dashboards, Reporting, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
...
## Capability: `Structured filtering`

| Field | Description |
|---|---|
| Capability ID | SUB-007-CAP-02 |
| Purpose | Provide controlled structured filtering within Search, Query, Views, Dashboards, Reporting, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Advanced query language`

| Field | Description |
|---|---|
| Capability ID | SUB-007-CAP-03 |
| Purpose | Provide controlled advanced query language within Search, Query, Views, Dashboards, Reporting, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-007-CAP-04 |
| Purpose | Provide controlled graph navigation within Search, Query, Views, Dashboards, Reporting, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-007-CAP-05 |
| Purpose | Provide controlled semantic search within Search, Query, Views, Dashboards, Reporting, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-007-CAP-06 |
| Purpose | Provide controlled natural-language q&a within Search, Query, Views, Dashboards, Reporting, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
| Field | Description |
|---|---|
| Capability ID | SUB-007-CAP-07 |
| Purpose | Provide controlled saved views within Search, Query, Views, Dashboards, Reporting, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Dashboards and widgets`

| Field | Description |
|---|---|
| Capability ID | SUB-007-CAP-08 |
| Purpose | Provide controlled dashboards and widgets within Search, Query, Views, Dashboards, Reporting, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `Scheduled reporting`

| Field | Description |
|---|---|
| Capability ID | SUB-007-CAP-09 |
| Purpose | Provide controlled scheduled reporting within Search, Query, Views, Dashboards, Reporting, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
## Capability: `BI/export integration`

| Field | Description |
|---|---|
| Capability ID | SUB-007-CAP-10 |
| Purpose | Provide controlled bi/export integration within Search, Query, Views, Dashboards, Reporting, consistent with shared identity, workflow, traceability, evidence, audit, baseline, search, integration, reporting, security, and automation services. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator, Owner, Contributor, Reviewer, Approver, Viewer, Auditor, External collaborator, Automation actor |
| Inputs | User action, API call, imported record, event, scheduled job, workflow transition, policy rule, related record, evidence item, or integration payload. |
| Outputs | Created or updated records, state changes, links, evidence requests, audit events, notifications, metrics, reports, and integration events. |
...
|---|---|---|
| SearchIndexDocument | Managed entity for Search, Query, Views, Dashboards, Reporting. | Yes |
| SavedView | Managed entity for Search, Query, Views, Dashboards, Reporting. | Yes |
| Dashboard | Managed entity for Search, Query, Views, Dashboards, Reporting. | Yes |
| DashboardWidget | Managed entity for Search, Query, Views, Dashboards, Reporting. | Yes |
| ReportDefinition | Managed entity for Search, Query, Views, Dashboards, Reporting. | Yes |
| MetricDefinition | Managed entity for Search, Query, Views, Dashboards, Reporting. | Yes |
| ReportRun | Managed entity for Search, Query, Views, Dashboards, Reporting. | Yes |
| ExportJob | Managed entity for Search, Query, Views, Dashboards, Reporting. | Yes |
| Query | Managed entity for Search, Query, Views, Dashboards, Reporting. | Yes |
| SemanticIndexEntry | Managed entity for Search, Query, Views, Dashboards, Reporting. | Yes |

## 6.2 Entity Attributes

## Entity: `SearchIndexDocument`
...
|---|---|---|---|
| Primary records | Search, Query, Views, Dashboards, Reporting | Search, reporting, graph, workflow, evidence, integrations | Component APIs, imports, automation, authorized users |
...
- Search results must enforce the same permissions as source records.
- Every executive metric must drill down to source records, evidence, and calculation definition.
- Natural-language answers must cite governed source records and indicate uncertainty.
