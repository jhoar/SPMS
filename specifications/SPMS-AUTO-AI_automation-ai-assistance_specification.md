# Automation & AI Assistance Specification

## 0. Document Control

| Field | Value |
|---|---|
| Specification ID | SPMS-AUTO-AI |
...
Provides rule automation, policy-as-code, scheduled jobs, event-driven actions, and governed source-grounded AI assistance.

## 1.2 Scope

This component includes:

- Rules engine and scheduled jobs.
- Policy-as-code execution.
- Automation actions and event processing.
- Grounded AI retrieval.
- AI summarization and drafting.
- Classification and duplicate suggestions.
- Impact and evidence gap assistance.
...
| Automation & AI Assistance | This specification. |
...
|---|---|---|---|---|
| SPMS-AUTO-AI-CAP-001 | Rules engine and scheduled jobs | Provides rules engine and scheduled jobs for Automation & AI Assistance. | Must | Yes |
| SPMS-AUTO-AI-CAP-002 | Policy-as-code execution | Provides policy-as-code execution for Automation & AI Assistance. | Must | Yes |
| SPMS-AUTO-AI-CAP-003 | Automation actions and event processing | Provides automation actions and event processing for Automation & AI Assistance. | Must | Yes |
| SPMS-AUTO-AI-CAP-004 | Grounded AI retrieval | Provides grounded ai retrieval for Automation & AI Assistance. | Must | Yes |
| SPMS-AUTO-AI-CAP-005 | AI summarization and drafting | Provides ai summarization and drafting for Automation & AI Assistance. | Should | No |
| SPMS-AUTO-AI-CAP-006 | Classification and duplicate suggestions | Provides classification and duplicate suggestions for Automation & AI Assistance. | Should | No |
| SPMS-AUTO-AI-CAP-007 | Impact and evidence gap assistance | Provides impact and evidence gap assistance for Automation & AI Assistance. | Should | No |
| SPMS-AUTO-AI-CAP-008 | Human-in-the-loop controls | Provides human-in-the-loop controls for Automation & AI Assistance. | Should | No |

## 4.2 Capability Details

## Capability: `Rules engine and scheduled jobs`

| Field | Description |
|---|---|
| Capability ID | SPMS-AUTO-AI-CAP-001 |
| Purpose | Support rules engine and scheduled jobs within the Automation & AI Assistance component. |
...
| Inputs | Automation & AI Assistance records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Automation & AI Assistance records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
| Related records | Automation rule, Scheduled job, Policy bundle, AI task, Grounded answer; approvals; baselines; evidence; trace links; reports. |
...
## Capability: `Policy-as-code execution`

| Field | Description |
|---|---|
| Capability ID | SPMS-AUTO-AI-CAP-002 |
| Purpose | Support policy-as-code execution within the Automation & AI Assistance component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Automation & AI Assistance records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Automation & AI Assistance records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Automation actions and event processing`

| Field | Description |
|---|---|
| Capability ID | SPMS-AUTO-AI-CAP-003 |
| Purpose | Support automation actions and event processing within the Automation & AI Assistance component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Automation & AI Assistance records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Automation & AI Assistance records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Grounded AI retrieval`

| Field | Description |
|---|---|
| Capability ID | SPMS-AUTO-AI-CAP-004 |
| Purpose | Support grounded ai retrieval within the Automation & AI Assistance component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Automation & AI Assistance records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Automation & AI Assistance records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `AI summarization and drafting`

| Field | Description |
|---|---|
| Capability ID | SPMS-AUTO-AI-CAP-005 |
| Purpose | Support ai summarization and drafting within the Automation & AI Assistance component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Automation & AI Assistance records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Automation & AI Assistance records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Classification and duplicate suggestions`

| Field | Description |
|---|---|
| Capability ID | SPMS-AUTO-AI-CAP-006 |
| Purpose | Support classification and duplicate suggestions within the Automation & AI Assistance component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Automation & AI Assistance records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Automation & AI Assistance records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Impact and evidence gap assistance`

| Field | Description |
|---|---|
| Capability ID | SPMS-AUTO-AI-CAP-007 |
| Purpose | Support impact and evidence gap assistance within the Automation & AI Assistance component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Automation & AI Assistance records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Automation & AI Assistance records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
| Field | Description |
|---|---|
| Capability ID | SPMS-AUTO-AI-CAP-008 |
| Purpose | Support human-in-the-loop controls within the Automation & AI Assistance component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Automation & AI Assistance records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Automation & AI Assistance records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
|---|---|---|
| Automation rule | Primary Automation & AI Assistance record for automation rule management. | Yes |
| Scheduled job | Primary Automation & AI Assistance record for scheduled job management. | Yes |
| Policy bundle | Primary Automation & AI Assistance record for policy bundle management. | Yes |
| AI task | Primary Automation & AI Assistance record for ai task management. | Yes |
| Grounded answer | Primary Automation & AI Assistance record for grounded answer management. | Yes |
| Suggestion | Primary Automation & AI Assistance record for suggestion management. | Shared |
| Tool invocation | Primary Automation & AI Assistance record for tool invocation management. | Shared |
| Automation audit event | Primary Automation & AI Assistance record for automation audit event management. | Shared |
...
|---|---|---|---|
| Automation rule | Automation & AI Assistance | Related modules, reporting, traceability, audit | This component and authorised imports |
| Trace links | Traceability Graph Core | Automation & AI Assistance, reporting, assurance, AI | This component via graph API |
| Evidence metadata | Evidence & Audit Core | Automation & AI Assistance, audit, reporting | Evidence service and authorised actors |
| Approval records | Workflow & Governance Core | Automation & AI Assistance, audit, reporting | Workflow service |
...
This specification covers the requested module scope: Rules engine and scheduled jobs, Policy-as-code execution, Automation actions and event processing, Grounded AI retrieval, AI summarization and drafting, Classification and duplicate suggestions, Impact and evidence gap assistance, Human-in-the-loop controls.
