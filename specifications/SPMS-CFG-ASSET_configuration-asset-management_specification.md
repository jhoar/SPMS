# Configuration & Asset Management Specification

## 0. Document Control

| Field | Value |
|---|---|
| Specification ID | SPMS-CFG-ASSET |
...
Manages CIs, assets, environments, topology, baselines, drift, deployment inventory, dependency impact, and operational handover data.
...
- Asset inventory.
- Environment registry and lifecycle.
- Topology and relationship model.
- Baseline and configuration control.
- Discovery and synchronization.
- Drift detection and reconciliation.
- Dependency and impact management.
...
| Configuration & Asset Management | This specification. |
...
|---|---|---|---|---|
| SPMS-CFG-ASSET-CAP-001 | Configuration item registry | Provides configuration item registry for Configuration & Asset Management. | Must | Yes |
| SPMS-CFG-ASSET-CAP-002 | Asset inventory | Provides asset inventory for Configuration & Asset Management. | Must | Yes |
| SPMS-CFG-ASSET-CAP-003 | Environment registry and lifecycle | Provides environment registry and lifecycle for Configuration & Asset Management. | Must | Yes |
| SPMS-CFG-ASSET-CAP-004 | Topology and relationship model | Provides topology and relationship model for Configuration & Asset Management. | Must | Yes |
| SPMS-CFG-ASSET-CAP-005 | Baseline and configuration control | Provides baseline and configuration control for Configuration & Asset Management. | Should | No |
...
| Field | Description |
|---|---|
| Capability ID | SPMS-CFG-ASSET-CAP-001 |
| Purpose | Support configuration item registry within the Configuration & Asset Management component. |
...
| Inputs | Configuration & Asset Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Configuration & Asset Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
| Related records | Configuration item, Asset, Environment, Topology node, Configuration baseline; approvals; baselines; evidence; trace links; reports. |
...
| Field | Description |
|---|---|
| Capability ID | SPMS-CFG-ASSET-CAP-002 |
| Purpose | Support asset inventory within the Configuration & Asset Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Configuration & Asset Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Configuration & Asset Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
| Field | Description |
|---|---|
| Capability ID | SPMS-CFG-ASSET-CAP-003 |
| Purpose | Support environment registry and lifecycle within the Configuration & Asset Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Configuration & Asset Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Configuration & Asset Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Topology and relationship model`

| Field | Description |
|---|---|
| Capability ID | SPMS-CFG-ASSET-CAP-004 |
| Purpose | Support topology and relationship model within the Configuration & Asset Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Configuration & Asset Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Configuration & Asset Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
| Field | Description |
|---|---|
| Capability ID | SPMS-CFG-ASSET-CAP-005 |
| Purpose | Support baseline and configuration control within the Configuration & Asset Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Configuration & Asset Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Configuration & Asset Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
| Field | Description |
|---|---|
| Capability ID | SPMS-CFG-ASSET-CAP-006 |
| Purpose | Support discovery and synchronization within the Configuration & Asset Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Configuration & Asset Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Configuration & Asset Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
| Field | Description |
|---|---|
| Capability ID | SPMS-CFG-ASSET-CAP-007 |
| Purpose | Support drift detection and reconciliation within the Configuration & Asset Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Configuration & Asset Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Configuration & Asset Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Dependency and impact management`

| Field | Description |
|---|---|
| Capability ID | SPMS-CFG-ASSET-CAP-008 |
| Purpose | Support dependency and impact management within the Configuration & Asset Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Configuration & Asset Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Configuration & Asset Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
|---|---|---|
| Configuration item | Primary Configuration & Asset Management record for configuration item management. | Yes |
| Asset | Primary Configuration & Asset Management record for asset management. | Yes |
...
|---|---|---|---|
| Configuration item | Configuration & Asset Management | Related modules, reporting, traceability, audit | This component and authorised imports |
| Trace links | Traceability Graph Core | Configuration & Asset Management, reporting, assurance, AI | This component via graph API |
| Evidence metadata | Evidence & Audit Core | Configuration & Asset Management, audit, reporting | Evidence service and authorised actors |
| Approval records | Workflow & Governance Core | Configuration & Asset Management, audit, reporting | Workflow service |
