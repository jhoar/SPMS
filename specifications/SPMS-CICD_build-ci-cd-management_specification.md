# Build & CI/CD Management Specification

## 0. Document Control

| Field | Value |
|---|---|
| Specification ID | SPMS-CICD |
| Component name | Build & CI/CD Management |
...
Manages pipelines, runners, builds, artifacts, provenance, gates, test evidence, security checks, and promotion readiness.

## 1.2 Scope

This component includes:

- Source and change intake.
...
- Artifact, provenance, and promotion management.
- Pipeline gates and evidence.
...
| Build & CI/CD Management | This specification. |
...
|---|---|---|---|---|
| SPMS-CICD-CAP-001 | Source and change intake | Provides source and change intake for Build & CI/CD Management. | Must | Yes |
| SPMS-CICD-CAP-002 | Pipeline definition and configuration | Provides pipeline definition and configuration for Build & CI/CD Management. | Must | Yes |
| SPMS-CICD-CAP-003 | Build orchestration | Provides build orchestration for Build & CI/CD Management. | Must | Yes |
| SPMS-CICD-CAP-004 | Runner and environment management | Provides runner and environment management for Build & CI/CD Management. | Must | Yes |
| SPMS-CICD-CAP-005 | Toolchain and dependency management | Provides toolchain and dependency management for Build & CI/CD Management. | Should | No |
| SPMS-CICD-CAP-006 | Test, quality, and security checks | Provides test, quality, and security checks for Build & CI/CD Management. | Should | No |
| SPMS-CICD-CAP-007 | Artifact, provenance, and promotion management | Provides artifact, provenance, and promotion management for Build & CI/CD Management. | Should | No |
| SPMS-CICD-CAP-008 | Pipeline gates and evidence | Provides pipeline gates and evidence for Build & CI/CD Management. | Should | No |

## 4.2 Capability Details

## Capability: `Source and change intake`

| Field | Description |
|---|---|
| Capability ID | SPMS-CICD-CAP-001 |
| Purpose | Support source and change intake within the Build & CI/CD Management component. |
...
| Inputs | Build & CI/CD Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Build & CI/CD Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
| Related records | Pipeline, Pipeline run, Stage, Job, Runner; approvals; baselines; evidence; trace links; reports. |
...
## Capability: `Pipeline definition and configuration`

| Field | Description |
|---|---|
| Capability ID | SPMS-CICD-CAP-002 |
| Purpose | Support pipeline definition and configuration within the Build & CI/CD Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Build & CI/CD Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Build & CI/CD Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
| Field | Description |
|---|---|
| Capability ID | SPMS-CICD-CAP-003 |
| Purpose | Support build orchestration within the Build & CI/CD Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Build & CI/CD Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Build & CI/CD Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Runner and environment management`

| Field | Description |
|---|---|
| Capability ID | SPMS-CICD-CAP-004 |
| Purpose | Support runner and environment management within the Build & CI/CD Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Build & CI/CD Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Build & CI/CD Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Toolchain and dependency management`

| Field | Description |
|---|---|
| Capability ID | SPMS-CICD-CAP-005 |
| Purpose | Support toolchain and dependency management within the Build & CI/CD Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Build & CI/CD Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Build & CI/CD Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Test, quality, and security checks`

| Field | Description |
|---|---|
| Capability ID | SPMS-CICD-CAP-006 |
| Purpose | Support test, quality, and security checks within the Build & CI/CD Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Build & CI/CD Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Build & CI/CD Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Artifact, provenance, and promotion management`

| Field | Description |
|---|---|
| Capability ID | SPMS-CICD-CAP-007 |
| Purpose | Support artifact, provenance, and promotion management within the Build & CI/CD Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Build & CI/CD Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Build & CI/CD Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Pipeline gates and evidence`

| Field | Description |
|---|---|
| Capability ID | SPMS-CICD-CAP-008 |
| Purpose | Support pipeline gates and evidence within the Build & CI/CD Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Build & CI/CD Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Build & CI/CD Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
|---|---|---|
| Pipeline | Primary Build & CI/CD Management record for pipeline management. | Yes |
| Pipeline run | Primary Build & CI/CD Management record for pipeline run management. | Yes |
| Stage | Primary Build & CI/CD Management record for stage management. | Yes |
| Job | Primary Build & CI/CD Management record for job management. | Yes |
| Runner | Primary Build & CI/CD Management record for runner management. | Yes |
| Build record | Primary Build & CI/CD Management record for build record management. | Shared |
| Artifact | Primary Build & CI/CD Management record for artifact management. | Shared |
| SBOM | Primary Build & CI/CD Management record for sbom management. | Shared |
| Provenance record | Primary Build & CI/CD Management record for provenance record management. | Shared |
...
|---|---|---|---|
| Pipeline | Build & CI/CD Management | Related modules, reporting, traceability, audit | This component and authorised imports |
| Trace links | Traceability Graph Core | Build & CI/CD Management, reporting, assurance, AI | This component via graph API |
| Evidence metadata | Evidence & Audit Core | Build & CI/CD Management, audit, reporting | Evidence service and authorised actors |
| Approval records | Workflow & Governance Core | Build & CI/CD Management, audit, reporting | Workflow service |
...
This specification covers the requested module scope: Source and change intake, Pipeline definition and configuration, Build orchestration, Runner and environment management, Toolchain and dependency management, Test, quality, and security checks, Artifact, provenance, and promotion management, Pipeline gates and evidence.

## 22.2 Specialized Rules

- Runner model must distinguish hosted, self-hosted, ephemeral, VM, containerized, bare-metal, and hardware-in-the-loop runners.
