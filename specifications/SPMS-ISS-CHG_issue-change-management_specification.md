# Issue & Change Management Specification

## 0. Document Control

| Field | Value |
|---|---|
| Specification ID | SPMS-ISS-CHG |
| Component name | Issue & Change Management |
...
Manages tickets, defects, actions, changes, NCRs, exceptions, approvals, evidence, and closure governance.
...
- Change control.
- NCR, exception, and action handling.
...
| Issue & Change Management | This specification. |
...
|---|---|---|---|---|
| SPMS-ISS-CHG-CAP-001 | Issue and change intake | Provides issue and change intake for Issue & Change Management. | Must | Yes |
| SPMS-ISS-CHG-CAP-002 | Classification and triage | Provides classification and triage for Issue & Change Management. | Must | Yes |
| SPMS-ISS-CHG-CAP-003 | Workflow and lifecycle management | Provides workflow and lifecycle management for Issue & Change Management. | Must | Yes |
| SPMS-ISS-CHG-CAP-004 | Assignment and accountability | Provides assignment and accountability for Issue & Change Management. | Must | Yes |
| SPMS-ISS-CHG-CAP-005 | Backlog and planning support | Provides backlog and planning support for Issue & Change Management. | Should | No |
| SPMS-ISS-CHG-CAP-006 | Change control | Provides change control for Issue & Change Management. | Should | No |
| SPMS-ISS-CHG-CAP-007 | NCR, exception, and action handling | Provides ncr, exception, and action handling for Issue & Change Management. | Should | No |
| SPMS-ISS-CHG-CAP-008 | Closure and verification | Provides closure and verification for Issue & Change Management. | Should | No |

## 4.2 Capability Details

## Capability: `Issue and change intake`

| Field | Description |
|---|---|
| Capability ID | SPMS-ISS-CHG-CAP-001 |
| Purpose | Support issue and change intake within the Issue & Change Management component. |
...
| Inputs | Issue & Change Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Issue & Change Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
| Related records | Issue, Change request, Defect, Action item, NCR; approvals; baselines; evidence; trace links; reports. |
...
## Capability: `Classification and triage`

| Field | Description |
|---|---|
| Capability ID | SPMS-ISS-CHG-CAP-002 |
| Purpose | Support classification and triage within the Issue & Change Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Issue & Change Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Issue & Change Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Workflow and lifecycle management`

| Field | Description |
|---|---|
| Capability ID | SPMS-ISS-CHG-CAP-003 |
| Purpose | Support workflow and lifecycle management within the Issue & Change Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Issue & Change Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Issue & Change Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Assignment and accountability`

| Field | Description |
|---|---|
| Capability ID | SPMS-ISS-CHG-CAP-004 |
| Purpose | Support assignment and accountability within the Issue & Change Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Issue & Change Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Issue & Change Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Backlog and planning support`

| Field | Description |
|---|---|
| Capability ID | SPMS-ISS-CHG-CAP-005 |
| Purpose | Support backlog and planning support within the Issue & Change Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Issue & Change Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Issue & Change Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
| Field | Description |
|---|---|
| Capability ID | SPMS-ISS-CHG-CAP-006 |
| Purpose | Support change control within the Issue & Change Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Issue & Change Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Issue & Change Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `NCR, exception, and action handling`

| Field | Description |
|---|---|
| Capability ID | SPMS-ISS-CHG-CAP-007 |
| Purpose | Support ncr, exception, and action handling within the Issue & Change Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Issue & Change Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Issue & Change Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Closure and verification`

| Field | Description |
|---|---|
| Capability ID | SPMS-ISS-CHG-CAP-008 |
| Purpose | Support closure and verification within the Issue & Change Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Issue & Change Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Issue & Change Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
|---|---|---|
| Issue | Primary Issue & Change Management record for issue management. | Yes |
| Change request | Primary Issue & Change Management record for change request management. | Yes |
| Defect | Primary Issue & Change Management record for defect management. | Yes |
| Action item | Primary Issue & Change Management record for action item management. | Yes |
| NCR | Primary Issue & Change Management record for ncr management. | Yes |
| Exception | Primary Issue & Change Management record for exception management. | Shared |
| Comment | Primary Issue & Change Management record for comment management. | Shared |
| Resolution | Primary Issue & Change Management record for resolution management. | Shared |
| SLA clock | Primary Issue & Change Management record for sla clock management. | Shared |
...
|---|---|---|---|
| Issue | Issue & Change Management | Related modules, reporting, traceability, audit | This component and authorised imports |
| Trace links | Traceability Graph Core | Issue & Change Management, reporting, assurance, AI | This component via graph API |
| Evidence metadata | Evidence & Audit Core | Issue & Change Management, audit, reporting | Evidence service and authorised actors |
| Approval records | Workflow & Governance Core | Issue & Change Management, audit, reporting | Workflow service |
...
This specification covers the requested module scope: Issue and change intake, Classification and triage, Workflow and lifecycle management, Assignment and accountability, Backlog and planning support, Change control, NCR, exception, and action handling, Closure and verification.

## 22.2 Specialized Rules

- Issue types must include bugs, tasks, stories, incidents, risks, changes, NCRs, waivers, decisions, and action items where configured.
- Closure must enforce acceptance criteria, verification status, evidence, review, definition of done, and regression links.
- Change control must route baseline, scope, release, requirement, and configuration changes through impact analysis and approvals.
- SLA management must support response, triage, review, approval, resolution, pause/resume, and escalation.
