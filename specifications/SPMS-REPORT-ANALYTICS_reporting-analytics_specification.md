...
| Field | Value |
|---|---|
| Specification ID | SPMS-REPORT-ANALYTICS |
...
| Authoritative | Yes |
| Supersedes | SPMS-FUN-015; SPMS-SUB-007 |
...
Provides dashboards, metrics, trends, BI exports, executive views, drill-down reporting, and scheduled analytics across all modules.
...
| Reporting & Analytics | This specification. |
...
|---|---|---|---|---|
| SPMS-REPORT-ANALYTICS-CAP-001 | Dashboard framework | Provides dashboard framework for Reporting & Analytics. | Must | Yes |
| SPMS-REPORT-ANALYTICS-CAP-002 | Metrics catalog and definitions | Provides metrics catalog and definitions for Reporting & Analytics. | Must | Yes |
| SPMS-REPORT-ANALYTICS-CAP-003 | Operational and executive reporting | Provides operational and executive reporting for Reporting & Analytics. | Must | Yes |
| SPMS-REPORT-ANALYTICS-CAP-004 | Trend and cohort analysis | Provides trend and cohort analysis for Reporting & Analytics. | Must | Yes |
| SPMS-REPORT-ANALYTICS-CAP-005 | Portfolio analytics | Provides portfolio analytics for Reporting & Analytics. | Should | No |
| SPMS-REPORT-ANALYTICS-CAP-006 | BI exports | Provides bi exports for Reporting & Analytics. | Should | No |
| SPMS-REPORT-ANALYTICS-CAP-007 | Evidence-backed drill-down | Provides evidence-backed drill-down for Reporting & Analytics. | Should | No |
| SPMS-REPORT-ANALYTICS-CAP-008 | Scheduled and self-service reports | Provides scheduled and self-service reports for Reporting & Analytics. | Should | No |

## 4.2 Capability Details

## Capability: `Dashboard framework`

| Field | Description |
|---|---|
| Capability ID | SPMS-REPORT-ANALYTICS-CAP-001 |
| Purpose | Support dashboard framework within the Reporting & Analytics component. |
...
| Inputs | Reporting & Analytics records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Reporting & Analytics records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
| Related records | Dashboard, Metric definition, Report, Report run, Dataset; approvals; baselines; evidence; trace links; reports. |
...
## Capability: `Metrics catalog and definitions`

| Field | Description |
|---|---|
| Capability ID | SPMS-REPORT-ANALYTICS-CAP-002 |
| Purpose | Support metrics catalog and definitions within the Reporting & Analytics component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Reporting & Analytics records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Reporting & Analytics records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Operational and executive reporting`

| Field | Description |
|---|---|
| Capability ID | SPMS-REPORT-ANALYTICS-CAP-003 |
| Purpose | Support operational and executive reporting within the Reporting & Analytics component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Reporting & Analytics records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Reporting & Analytics records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Trend and cohort analysis`

| Field | Description |
|---|---|
| Capability ID | SPMS-REPORT-ANALYTICS-CAP-004 |
| Purpose | Support trend and cohort analysis within the Reporting & Analytics component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Reporting & Analytics records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Reporting & Analytics records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
| Field | Description |
|---|---|
| Capability ID | SPMS-REPORT-ANALYTICS-CAP-005 |
| Purpose | Support portfolio analytics within the Reporting & Analytics component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Reporting & Analytics records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Reporting & Analytics records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
| Field | Description |
|---|---|
| Capability ID | SPMS-REPORT-ANALYTICS-CAP-006 |
| Purpose | Support bi exports within the Reporting & Analytics component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Reporting & Analytics records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Reporting & Analytics records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Evidence-backed drill-down`

| Field | Description |
|---|---|
| Capability ID | SPMS-REPORT-ANALYTICS-CAP-007 |
| Purpose | Support evidence-backed drill-down within the Reporting & Analytics component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Reporting & Analytics records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Reporting & Analytics records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Scheduled and self-service reports`

| Field | Description |
|---|---|
| Capability ID | SPMS-REPORT-ANALYTICS-CAP-008 |
| Purpose | Support scheduled and self-service reports within the Reporting & Analytics component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Reporting & Analytics records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Reporting & Analytics records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
|---|---|---|
| Dashboard | Primary Reporting & Analytics record for dashboard management. | Yes |
| Metric definition | Primary Reporting & Analytics record for metric definition management. | Yes |
| Report | Primary Reporting & Analytics record for report management. | Yes |
| Report run | Primary Reporting & Analytics record for report run management. | Yes |
| Dataset | Primary Reporting & Analytics record for dataset management. | Yes |
| Export job | Primary Reporting & Analytics record for export job management. | Shared |
| Analytic view | Primary Reporting & Analytics record for analytic view management. | Shared |
| KPI threshold | Primary Reporting & Analytics record for kpi threshold management. | Shared |
...
|---|---|---|---|
| Dashboard | Reporting & Analytics | Related modules, reporting, traceability, audit | This component and authorised imports |
| Trace links | Traceability Graph Core | Reporting & Analytics, reporting, assurance, AI | This component via graph API |
| Evidence metadata | Evidence & Audit Core | Reporting & Analytics, audit, reporting | Evidence service and authorised actors |
| Approval records | Workflow & Governance Core | Reporting & Analytics, audit, reporting | Workflow service |
...
This specification covers the requested module scope: Dashboard framework, Metrics catalog and definitions, Operational and executive reporting, Trend and cohort analysis, Portfolio analytics, BI exports, Evidence-backed drill-down, Scheduled and self-service reports.

## 22.2 Specialized Rules

- Metrics definitions must be governed to avoid inconsistent local calculations.
- Dashboards must support drill-down from executive indicators to source records and evidence.
- BI exports must enforce permissions, classification, and audit logging.
- Trend analytics must support time series, cohorts, baselines, releases, teams, projects, portfolios, and governance profiles.
