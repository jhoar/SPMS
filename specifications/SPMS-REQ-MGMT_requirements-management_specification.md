...
| Field | Value |
|---|---|
| Specification ID | SPMS-REQ-MGMT |
| Component name | Requirements Management |
| Component type | Functional module |
| Version | 0.2 |
| Status | Draft — Authoritative (reconciled set v1) |
| Owner | Requirements & V&V Lead |
...
Manages the controlled lifecycle of requirements from capture through review, baseline, change, traceability, verification, acceptance, and audit.

## 1.2 Scope

This component includes:

- Requirement capture and intake.
- Requirement metadata and hierarchy.
- Authoring quality checks.
- Review, approval, and baselining.
- Change control.
- Traceability management.
- Verification method planning.
- Acceptance and compliance reporting.
...
| Requirements Management | This specification. |
...
|---|---|---|---|---|
| SPMS-REQ-MGMT-CAP-001 | Requirement capture and intake | Provides requirement capture and intake for Requirements Management. | Must | Yes |
| SPMS-REQ-MGMT-CAP-002 | Requirement metadata and hierarchy | Provides requirement metadata and hierarchy for Requirements Management. | Must | Yes |
| SPMS-REQ-MGMT-CAP-003 | Authoring quality checks | Provides authoring quality checks for Requirements Management. | Must | Yes |
| SPMS-REQ-MGMT-CAP-004 | Review, approval, and baselining | Provides review, approval, and baselining for Requirements Management. | Must | Yes |
| SPMS-REQ-MGMT-CAP-005 | Change control | Provides change control for Requirements Management. | Should | No |
| SPMS-REQ-MGMT-CAP-006 | Traceability management | Provides traceability management for Requirements Management. | Should | No |
| SPMS-REQ-MGMT-CAP-007 | Verification method planning | Provides verification method planning for Requirements Management. | Should | No |
| SPMS-REQ-MGMT-CAP-008 | Acceptance and compliance reporting | Provides acceptance and compliance reporting for Requirements Management. | Should | No |

## 4.2 Capability Details

## Capability: `Requirement capture and intake`

| Field | Description |
|---|---|
| Capability ID | SPMS-REQ-MGMT-CAP-001 |
| Purpose | Support requirement capture and intake within the Requirements Management component. |
...
| Inputs | Requirements Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Requirements Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
| Related records | Requirement, Requirement set, Requirement baseline, Verification method, Acceptance criterion; approvals; baselines; evidence; trace links; reports. |
...
## Capability: `Requirement metadata and hierarchy`

| Field | Description |
|---|---|
| Capability ID | SPMS-REQ-MGMT-CAP-002 |
| Purpose | Support requirement metadata and hierarchy within the Requirements Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Requirements Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Requirements Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Authoring quality checks`

| Field | Description |
|---|---|
| Capability ID | SPMS-REQ-MGMT-CAP-003 |
| Purpose | Support authoring quality checks within the Requirements Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Requirements Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Requirements Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Review, approval, and baselining`

| Field | Description |
|---|---|
| Capability ID | SPMS-REQ-MGMT-CAP-004 |
| Purpose | Support review, approval, and baselining within the Requirements Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Requirements Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Requirements Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
| Field | Description |
|---|---|
| Capability ID | SPMS-REQ-MGMT-CAP-005 |
| Purpose | Support change control within the Requirements Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Requirements Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Requirements Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Traceability management`

| Field | Description |
|---|---|
| Capability ID | SPMS-REQ-MGMT-CAP-006 |
| Purpose | Support traceability management within the Requirements Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Requirements Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Requirements Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Verification method planning`

| Field | Description |
|---|---|
| Capability ID | SPMS-REQ-MGMT-CAP-007 |
| Purpose | Support verification method planning within the Requirements Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Requirements Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Requirements Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Acceptance and compliance reporting`

| Field | Description |
|---|---|
| Capability ID | SPMS-REQ-MGMT-CAP-008 |
| Purpose | Support acceptance and compliance reporting within the Requirements Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Requirements Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Requirements Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
|---|---|---|
| Requirement | Primary Requirements Management record for requirement management. | Yes |
| Requirement set | Primary Requirements Management record for requirement set management. | Yes |
| Requirement baseline | Primary Requirements Management record for requirement baseline management. | Yes |
| Verification method | Primary Requirements Management record for verification method management. | Yes |
| Acceptance criterion | Primary Requirements Management record for acceptance criterion management. | Yes |
| Change request | Primary Requirements Management record for change request management. | Shared |
| Requirement link | Primary Requirements Management record for requirement link management. | Shared |
| Applicability rule | Primary Requirements Management record for applicability rule management. | Shared |
...
|---|---|---|---|
| Requirement | Requirements Management | Related modules, reporting, traceability, audit | This component and authorised imports |
| Trace links | Traceability Graph Core | Requirements Management, reporting, assurance, AI | This component via graph API |
| Evidence metadata | Evidence & Audit Core | Requirements Management, audit, reporting | Evidence service and authorised actors |
| Approval records | Workflow & Governance Core | Requirements Management, audit, reporting | Workflow service |
...
This specification covers the requested module scope: Requirement capture and intake, Requirement metadata and hierarchy, Authoring quality checks, Review, approval, and baselining, Change control, Traceability management, Verification method planning, Acceptance and compliance reporting.

## 22.2 Specialized Rules

- Requirement quality rules must check ambiguity, atomicity, testability, completeness, consistency, terminology, units, and traceability.
