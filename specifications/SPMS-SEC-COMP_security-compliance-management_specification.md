# Security & Compliance Management Specification

## 0. Document Control

| Field | Value |
|---|---|
| Specification ID | SPMS-SEC-COMP |
...
Manages controls, vulnerabilities, threats, risk, privacy, compliance evidence, exceptions, remediation, and security release readiness.

## 1.2 Scope

This component includes:

- Security governance and control library.
...
| Security & Compliance Management | This specification. |
...
|---|---|---|---|---|
| SPMS-SEC-COMP-CAP-001 | Security governance and control library | Provides security governance and control library for Security & Compliance Management. | Must | Yes |
| SPMS-SEC-COMP-CAP-002 | Security and compliance requirements | Provides security and compliance requirements for Security & Compliance Management. | Must | Yes |
| SPMS-SEC-COMP-CAP-003 | Risk and threat modelling | Provides risk and threat modelling for Security & Compliance Management. | Must | Yes |
| SPMS-SEC-COMP-CAP-004 | Vulnerability intake and triage | Provides vulnerability intake and triage for Security & Compliance Management. | Must | Yes |
| SPMS-SEC-COMP-CAP-005 | Remediation and patch management | Provides remediation and patch management for Security & Compliance Management. | Should | No |
...
## Capability: `Security governance and control library`

| Field | Description |
|---|---|
| Capability ID | SPMS-SEC-COMP-CAP-001 |
| Purpose | Support security governance and control library within the Security & Compliance Management component. |
...
| Inputs | Security & Compliance Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Security & Compliance Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Security and compliance requirements`

| Field | Description |
|---|---|
| Capability ID | SPMS-SEC-COMP-CAP-002 |
| Purpose | Support security and compliance requirements within the Security & Compliance Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Security & Compliance Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Security & Compliance Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Risk and threat modelling`

| Field | Description |
|---|---|
| Capability ID | SPMS-SEC-COMP-CAP-003 |
| Purpose | Support risk and threat modelling within the Security & Compliance Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Security & Compliance Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Security & Compliance Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Vulnerability intake and triage`

| Field | Description |
|---|---|
| Capability ID | SPMS-SEC-COMP-CAP-004 |
| Purpose | Support vulnerability intake and triage within the Security & Compliance Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Security & Compliance Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Security & Compliance Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Remediation and patch management`

| Field | Description |
|---|---|
| Capability ID | SPMS-SEC-COMP-CAP-005 |
| Purpose | Support remediation and patch management within the Security & Compliance Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Security & Compliance Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Security & Compliance Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Supply-chain and SBOM controls`

| Field | Description |
|---|---|
| Capability ID | SPMS-SEC-COMP-CAP-006 |
| Purpose | Support supply-chain and sbom controls within the Security & Compliance Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Security & Compliance Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Security & Compliance Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Privacy and data protection`

| Field | Description |
|---|---|
| Capability ID | SPMS-SEC-COMP-CAP-007 |
| Purpose | Support privacy and data protection within the Security & Compliance Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Security & Compliance Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Security & Compliance Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
## Capability: `Compliance assessment and audit`

| Field | Description |
|---|---|
| Capability ID | SPMS-SEC-COMP-CAP-008 |
| Purpose | Support compliance assessment and audit within the Security & Compliance Management component. |
| Trigger | Manual / Scheduled / Event-driven / API / Integration / AI-assisted |
| Primary users | Administrator; Owner; Contributor; Reviewer; Approver; Auditor; Automation actor |
| Inputs | Security & Compliance Management records, related links, metadata, policy configuration, comments, evidence, and events. |
| Outputs | Updated Security & Compliance Management records, state changes, evidence links, audit events, notifications, metrics, and reports. |
...
|---|---|---|
| Control | Primary Security & Compliance Management record for control management. | Yes |
| Security requirement | Primary Security & Compliance Management record for security requirement management. | Yes |
| Risk | Primary Security & Compliance Management record for risk management. | Yes |
| Threat model | Primary Security & Compliance Management record for threat model management. | Yes |
| Vulnerability | Primary Security & Compliance Management record for vulnerability management. | Yes |
| Finding | Primary Security & Compliance Management record for finding management. | Shared |
...
|---|---|---|---|
| Control | Security & Compliance Management | Related modules, reporting, traceability, audit | This component and authorised imports |
| Trace links | Traceability Graph Core | Security & Compliance Management, reporting, assurance, AI | This component via graph API |
| Evidence metadata | Evidence & Audit Core | Security & Compliance Management, audit, reporting | Evidence service and authorised actors |
| Approval records | Workflow & Governance Core | Security & Compliance Management, audit, reporting | Workflow service |
